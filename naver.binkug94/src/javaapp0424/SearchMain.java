...
public class SearchMain {
	...
	public static void main(String[] args) {
		...
		String [] soccers = {"반바스텐","베르캄프","조지웨어","크루이프","호나우드"
				,"기린샤","펠레","마라도나","차범근","굴리트"};
		
		//데이터 정렬
		Arrays.sort(soccers);
		for(String i : soccers) {
			System.out.println(i);
		}

		//호날두가 있는지 검색
		System.out.println(Arrays.binarySearch(soccers,"호날두"));
		System.out.println(Arrays.binarySearch(soccers,"굴리트"));
